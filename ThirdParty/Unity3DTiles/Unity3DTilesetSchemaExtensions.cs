...
namespace Unity3DTiles.Schema
{
    public static class Unity3DTilesetSchemaExtensions
    {
        ...
        public static Matrix4x4d UnityTransform(this Schema.Tile tile)
        {
            ...
            m.SetColumn(0, new Vector4d(tile.Transform[0],
                                       tile.Transform[1],
                                       tile.Transform[2],
                                       tile.Transform[3]));
            m.SetColumn(1, new Vector4d(tile.Transform[4],
                                       tile.Transform[5],
                                       tile.Transform[6],
                                       tile.Transform[7]));
            m.SetColumn(2, new Vector4d(tile.Transform[8],
                                       tile.Transform[9],
                                       tile.Transform[10],
                                       tile.Transform[11]));
            m.SetColumn(3, new Vector4d(tile.Transform[12],
                                       tile.Transform[13],
                                       tile.Transform[14],
                                       tile.Transform[15]));
            return m;
