...
namespace Unity3DTiles
{
    ...
    public class TileOrientedBoundingBox : Unity3DTileBoundingVolume
    {
        ...
        public Vector3d HalfAxesX3d;
        public Vector3d HalfAxesY3d;
        public Vector3d HalfAxesZ3d;
        ...
        public TileOrientedBoundingBox(Vector3d center, Vector3d halfAxesX, Vector3d halfAxesY, Vector3d halfAxesZ)
        {
            this.Center3d = center;
            this.HalfAxesX3d = halfAxesX;
            this.HalfAxesY3d = halfAxesY;
            this.HalfAxesZ3d = halfAxesZ;
        }
        ...
        public void Transform(Matrix4x4d transform)
        {
            this.Center3d = transform.MultiplyPoint(this.Center3d);
            this.HalfAxesX3d = transform.MultiplyVector(this.HalfAxesX3d);
            this.HalfAxesY3d = transform.MultiplyVector(this.HalfAxesY3d);
            this.HalfAxesZ3d = transform.MultiplyVector(this.HalfAxesZ3d);
        }
    }
    ...
    public class TileBoundingSphere : Unity3DTileBoundingVolume
    {
        ...
        public TileBoundingSphere(Vector3 center, float radius)
        {
            ...
            this.Center3d = center.ToVector3d();
            this._BoundingSphere = BoundingSphere();
        }
        ...
        public void Transform(Matrix4x4d transform)
        {
            ...
            Vector3d scale = new Vector3d(
                transform.GetColumn(0).Length(),
                transform.GetColumn(1).Length(),
                transform.GetColumn(2).Length()
            );
            double maxScale = Math.Max(scale.x, Math.Max(scale.y, scale.z));
            this.Radius *= (float)maxScale;
        }
