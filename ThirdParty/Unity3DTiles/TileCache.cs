...
namespace Unity3DTiles
{
    public class TileCache
    {
        ...
        private readonly Dictionary<Unity3DTile, LinkedListNode<Unity3DTile>> nodeLookup = new Dictionary<Unity3DTile, LinkedListNode<Unity3DTile>>();
        ...
        public bool Add(Unity3DTile tile, out bool duplicate)
        {
            ...
            if (Full)
            {
                int count = MarkLowPriorityUnused(t => t.FrameState.Priority > tile.FrameState.Priority);
                if (UnloadUnusedContent(1, count) == 0)
                {
                    return false;
                }
            }
