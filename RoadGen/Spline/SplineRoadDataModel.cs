...
namespace GeoDCBuildTools.RoadTool
{
    ...
    public class RoadInfoData
    {
        ...
        public SplineRoadMeshGenerator splineRoadMeshGenerator;

        public RoadInfoData(int id, float width, List<Vector3> points)
        {
            this.id = id;
            this.width = width;
            this.points = points;
    ...
    public class IntersectionInfoData
    {
        ...
        public IntersectionInfoData(Vector3 point, int forkNum, Dictionary<int, EndpointType> roadIds)
        {
            this.point = point;
