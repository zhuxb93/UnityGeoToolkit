...
namespace GeoToolkit.DrawRailway
{
    public class DrawRailwayMeshGenerator
    {
        public string id;
        public float width;
        ...
        public DrawRailwayMeshGenerator(string id, float width, float scaleFactor, List<Vector3> points, DrawRoadDataConfig config)
        {
            this.id = id;
            this.width = width;
        ...
        public void CalculateRailwayData()
        {
            ...
            int roadResolution = Mathf.CeilToInt(spline.GetLength() / 2);
