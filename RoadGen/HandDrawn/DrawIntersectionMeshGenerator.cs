...
{
    public class DrawIntersectionMeshGenerator
    {
        public int id;
        ...
        public List<DrawRoadMeshGenerator> connectedRoads;
        ...
        public DrawIntersectionMeshGenerator(int id, Vector3 point, int forkNum, Dictionary<int, EndpointType> roadIds, Dictionary<DrawRoadMeshGenerator, EndpointType> connectedRoadDict, float scaleFactor, DrawRoadDataConfig roadDataConfig)
        {
            this.id = id;
            ...
            intersectionMat = roadDataConfig.intersectionMatConfig.intersectionMat;
            crossingMat = roadDataConfig.intersectionMatConfig.crossingMat;
        ...
        public void CalculateJunctionInfo()
        {
            ...
            for (int i = 0; i < connectedRoads.Count; i++)
            {
                DrawRoadMeshGenerator road = connectedRoads[i];
